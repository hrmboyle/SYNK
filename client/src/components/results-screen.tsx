...
export function ResultsScreen({
  ...
  const renderSelectedSigil = () => {
    ...
    if (
      results.selectedSigil.toLowerCase().includes('triangle') ||
      results.selectedSigil.toLowerCase().includes('ascension')
    ) {
      return (
        <div className='absolute inset-0 flex items-center justify-center'>
          <div
            className='w-8 h-8 border-2 border-mystical-gold'
      ...
      return (
        <div className='absolute inset-0 flex items-center justify-center'>
          <div
            className='w-10 h-5 border-2 border-mystical-gold rounded-full'
          ...
          <Card className='question-card p-8 mystical-glow text-center'>
            <CardContent className='pt-6'>
              ...
              <p className='text-cosmic-200'>
                {results.selectedSigil} - Symbol of rising consciousness and
                spiritual evolution
              </p>
            </CardContent>
          </Card>
              ...
              <div className='bg-cosmic-800/50 p-6 rounded-xl border border-cosmic-600'>
                ...
                <div className='flex items-center space-x-4 mb-4'>
                  ...
                  <div className='flex-1'>
                    <p className='font-medium text-mystical-pearl'>
                      Echoes of Your Journey
                    </p>
                    <p className='text-sm text-cosmic-400'>
                      Generated from your cosmic answers
                    </p>
                  </div>
                </div>
              ...
              <div className='space-y-4'>
                <div className='flex items-start space-x-3'>
                  ...
                  <div>
                    ...
                    <p className='text-mystical-pearl'>
                      "{selectedAnswers.riddle}"
                    </p>
                  </div>
                </div>
                <div className='flex items-start space-x-3'>
